...
public class Dish implements Serializable {
	...
	public Collection<Component> getComponenets() {
		return Collections.unmodifiableCollection(componenets);
	}
	...
	public double calcDishPrice() {
	 ...
	 public boolean addComponent(Component c) { // add a component
	
		return componenets.add(c);
	}
	public boolean removeComponent(Component c) { // remove a component
		 if(componenets.contains(c))
			 return componenets.remove(c);
